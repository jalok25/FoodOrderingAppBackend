...
public class RestaurantController {
    ...
    //Controller to get the  list of all the restaurants
    @CrossOrigin
    ...
    //Controller to get all the restaurant by name
    @CrossOrigin
    ...
    //Controller to get restaurants by category ID
    @CrossOrigin
    ...
    //Controller to get restaurant details by restaurant ID
    @CrossOrigin
