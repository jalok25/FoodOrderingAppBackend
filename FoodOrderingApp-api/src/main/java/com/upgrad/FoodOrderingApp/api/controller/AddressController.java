...
public class AddressController {
    ...
    //Controller to save address for a customer
    @CrossOrigin
    ...
    //Controller for retrieving all the saved addresses in the database
    ...
    //Controller for retrieving all the states in the database
